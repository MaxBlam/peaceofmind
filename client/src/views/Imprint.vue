<template>
  <div class="container pt-5 mt-5">
    ...
    <p>
      Piece of Mind<br />Max Blam<br />Thaliastraße 125, Höhere Abteilung für
      Informationstechnologie, <br />1160 Wien, <br />Österreich
    </p>
    <p><strong>Unternehmensgegenstand:</strong> IT Dienstleistungen</p>
    <p>
    ...
    <p>
      ...
      <br />Sollten Sie Fragen zum Datenschutz haben, finden Sie nachfolgend die
      Kontaktdaten der verantwortlichen Person bzw. Stelle:<br />Piece of
      Mind<br />
      Thaliastraße 125, 1160 Wien, Österreich<br />Impressum:
      <a href="https://www.pieceofmind.at/imprint" target="_self" rel="noopener"
    ...
    <h2 id="haftung-fuer-inhalte-dieser-webseite">
    ...
    <p>Die Bilderrechte liegen bei den folgenden Fotografen und Personen:</p>
    <ul>
    ...
    <ul>
      ...
      <li>
        <a href="#sicherheit-datenverarbeitung"
          >Sicherheit der Datenverarbeitung</a
        >
      </li>
      <li>
      ...
      <li>
        <a href="#bootstrapcdn-datenschutzerklaerung"
          >BootstrapCDN Datenschutzerklärung</a
        >
      </li>
      <li>
        <a href="#instagram-datenschutzerklaerung"
          >Instagram Datenschutzerklärung</a
        >
      </li>
      <li>
        <a href="#linkedin-datenschutzerklaerung"
          >LinkedIn Datenschutzerklärung</a
        >
      </li>
    </ul>
    ...
    <p>
      ...
      <strong>Links</strong> zu weiterführenden Informationen geboten und
    ...
    <ol>
      <li>
        ...
        haben uns Ihre Einwilligung gegeben, Daten zu einem bestimmten Zweck zu
        verarbeiten. Ein Beispiel wäre die Speicherung Ihrer eingegebenen Daten
      ...
      <li>
        ...
        verarbeiten wir Ihre Daten. Wenn wir zum Beispiel einen Kaufvertrag mit
    ...
    <p>
      <strong>Leiterin: </strong>Mag. Dr. Andrea Jelinek<strong>
        <br />
        Adresse: </strong
      >Barichgasse 40-42, 1030 Wien<strong>
        <br />
        Telefonnr.: </strong
      >+43 1 52 152-0<strong>
        <br />
        E-Mail-Adresse:
      </strong>
    ...
    <p>
      ...
      dass man sowohl bei Software (z. B. Formularen) also auch Hardware (z. B.
    ...
    <p>
      ...
      beispielseite.de) und der Verwendung des Schemas https (anstatt http) als
      Teil unserer Internetadresse.<br />
    ...
    <p>
      ...
      sparsam und nur mit Begründung verarbeitet werden. Mit Website meinen wir
      übrigens die Gesamtheit aller Webseiten auf einer Domain, d.h. alles von
    ...
    <p>
      ...
      dafür ein Programm, das sich Webbrowser nennt. Sie kennen vermutlich
    ...
    <p>
      ...
      der Regel von professionellen Anbietern, den Providern, übernommen wird.
      Diese bieten Webhosting an und sorgen damit für eine verlässliche und
    ...
    <p>
      ...
      eine Zeit lang speichern, um einen ordentlichen Betrieb zu gewährleisten.
    </p>
    ...
    <h2 id="bootstrapcdn-datenschutzerklaerung">
      ...
      <tbody>
        <tr>
          <td>
            ...
            schneller laden zu können)<br />
            &#x1f4d3; Verarbeitete Daten: Daten wie etwa Ihre IP-Adresse,
            Browsertyp, Browserversion, welche Webseite geladen wird oder
            Uhrzeit und Datum des Seitenbesuchs<br />
    ...
    <p>
      Um Ihnen all unsere einzelnen Webseiten (Unterseiten unserer Website) auf
      allen Geräten schnell und sicher ausliefern zu können, nutzen wir das
      Content Delivery Network (CDN) BootstrapCDN, ein Open-Source-Dienst von
      <a
        ...
        >jsdelivr.com</a
      >
      des polnischen Software-Unternehmens ProspectOne, Królewska 65A/1, 30-081,
      Kraków, Polen. Ein Content Delivery Network (CDN) ist ein Netzwerk
      regional verteilter Server, die über das Internet miteinander verbunden
      sind. Durch dieses Netzwerk können Inhalte, speziell sehr große Dateien,
      auch bei großen Lastspitzen schnell ausgeliefert werden.
    </p>
    <h3>Warum verwenden wir BootstrapCDN?</h3>
    <p>
      Selbstverständlich wollen wir Ihnen mit unserer Website einen umfassenden
      und gut funktionierenden Service bieten. Dazu zählt auch eine schnelle
      Website. Mit jsdelivr.com-CDN kann unsere Website bei Ihnen viel schneller
      geladen werden. Besonders hilfreich wird der Einsatz von jsdelivr.com-CDN
    ...
    <p>
      ...
      BootstrapCDN herunter, wird Ihre IP-Adresse während der Verbindung zum
      Bootstrap-CDN-Server übermittelt. Es können also auch personenbezogene
      Daten gesendet und gespeichert werden. BootstrapCDN kann somit Userdaten
      wie IP-Adresse, Browsertyp, Browserversion, welche Webseite geladen wird
      oder Uhrzeit und Datum des Seitenbesuchs sammeln und speichern. In der
      Datenschutzerklärung von BootstrapCDN bzw.
      <a
        href="https://www.jsdelivr.com/"
        target="_blank"
        rel="follow noopener noreferrer"
    ...
    <p>
      ...
      werden. BootstrapCDN bewahrt personenbezogene Daten, die in unserem
      Auftrag verarbeitet werden, so lange auf, wie es für die Erbringung
      angebotener Dienstleistungen erforderlich ist, wie es für die Erfüllung
      rechtlichen Verpflichtungen, die Beilegung von Streitigkeiten und die
      Durchsetzung der Vereinbarungen notwendig ist.
    </p>
    ...
    <p>
      ...
      <a href="https://noscript.net/" target="_blank" rel="noopener noreferrer"
        >https://noscript.net/</a
      >) installieren oder in Ihrem Browser die Ausführung von JavaScript-Codes
      deaktivieren. Bitte beachten Sie aber, dass dadurch die Website nicht mehr
      das gewohnte Service (wie etwa schnelle Ladegeschwindigkeit) bieten kann.
    </p>
    <h3>Rechtsgrundlage</h3>
    <p>
      Wenn Sie eingewilligt haben, dass BootstrapCDN eingesetzt werden darf, ist
      ...
      >
      die Rechtsgrundlage für die Verarbeitung personenbezogener Daten, wie sie
      bei der Erfassung durch BootstrapCDN vorkommen kann, dar.
    </p>
    <p>
      Von unserer Seite besteht zudem ein berechtigtes Interesse, BootstrapCDN
      zu verwenden, um unser Online-Service zu optimieren und sicherer zu
      machen. Die dafür entsprechende Rechtsgrundlage ist
      <strong>Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</strong>. Wir
      setzen BootstrapCDN gleichwohl nur ein, soweit Sie eine Einwilligung
      erteilt haben.
    </p>
    <p>
      ...
      besteht. Die Datenverarbeitung geschieht im Wesentlichen durch
      BootstrapCDN. Dies kann dazu führen, dass gegebenenfalls Daten nicht
      ...
      möglichen anderen Diensten von BootstrapCDN, bei denen Sie ein Nutzerkonto
      haben, verknüpft werden.
    </p>
    <p>
      Mehr Informationen zum Datenschutz bei BootstrapCDN finden Sie auf
      <a
        href="https://www.jsdelivr.com/terms/privacy-policy-jsdelivr-net?tid=111870266"
        target="_blank"
        rel="follow noopener"
